...
import 'im_skeleton_rowcol.dart';
...
class _IMSkeletonState extends State<IMSkeleton>
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> skeletonRows = widget.rowCol.objects
        .map((row) => Row(
        children: row.map((obj) => _buildObj(context, obj)).toList()))
        .toList();
    ...
    var skeletonRowCol = Column(mainAxisSize: MainAxisSize.min, children: skeletonRows); // 行列布局
